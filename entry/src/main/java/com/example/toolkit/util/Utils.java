...
public class Utils {
    ...
    private static final String S_BUNDLE_NAME = "com.example.toolkit";

    // HiLogLabel定义了域信息和标签等
    private static final HiLogLabel S_LOG_LABEL = new HiLogLabel(HiLog.LOG_APP, 0x00101, "toolkit");
     ...
     * @return Intent对象
     */
    public static Intent generatePageNavigationIntent(String pagename, String key, String value) {
        // 创建Intent对象
